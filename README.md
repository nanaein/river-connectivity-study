* Take main rivers if tributaries are in discarded rivers (i.e., they are not in a shapefile of NaturalEarth), then add up the frequency of the main rivers accordingly.
